...
//        solution.runScoringStrategy(cube.clone(), 1000);
        solution.runForesightScoringStrategy(cube.clone(), 100, 4, 8, 0.4, 6);
...
//        solution.runMultipleForesightScoringStrategy(cube.clone(), 200);
    ...
    public void runForesightScoringStrategy(RubikCube cube, int limit, int foresightCount, int maxForesightCount, Double thresholdScoreToIncreaseForesightCount, int skipLastScoreCount){
        ScoringMechanism<RubikCube> scoring = new RubikCubeScoringByCompletionPercentage();
        ForesightScoringStrategy<RubikCube> foresightScoringStrategy = new ForesightScoringStrategy<>(limit, foresightCount, maxForesightCount, thresholdScoreToIncreaseForesightCount, skipLastScoreCount, scoring);
